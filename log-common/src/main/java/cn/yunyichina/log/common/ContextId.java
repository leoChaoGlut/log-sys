 ...
 * @CreateTime: 2017/4/25 14:36
 * @Description: copy from Mongo-java-driver 3.4.2
 */
public final class ContextId implements Comparable<ContextId>, Serializable {
    ...
    public static String getStr() {
        return new ContextId().toHexString();
    }
     ...
     * @return
     */
    public static long getTimestamp(String contextId) {
        String timestampStr = contextId.substring(0, 8);
        int timestamp = Integer.valueOf(timestampStr, 16);
     ...
     * @return the new id
     */
    public static ContextId get() {
        return new ContextId();
    }

    /**
     * Checks if a string could be an {@code ContextId}.
     *
     * @param hexString a potential ContextId as a String.
    ...
    /**
     * <p>Creates an ContextId using time, machine and inc values.  The Java driver used to create all ObjectIds this way, but it does not
     * match the <a href="http://docs.mongodb.org/manual/reference/object-id/">ContextId specification</a>, which requires four values, not
     ...
     * @return a new {@code ContextId} created from the given values
     * @since 2.12.0
     */
    public static ContextId createFromLegacyFormat(final int time, final int machine, final int inc) {
        return new ContextId(time, machine, inc);
    }
     ...
     * @param date the date
     */
    public ContextId(final Date date) {
     ...
     */
    public ContextId(final Date date, final int counter) {
     ...
     */
    public ContextId(final Date date, final int machineIdentifier, final short processIdentifier, final int counter) {
        this(dateToTimestampSeconds(date), machineIdentifier, processIdentifier, counter);
    }

    /**
     * Creates an ContextId using the given time, machine identifier, process identifier, and counter.
     *
     ...
     * @throws IllegalArgumentException if the high order byte of machineIdentifier or counter is not zero
     */
    public ContextId(final int timestamp, final int machineIdentifier, final short processIdentifier, final int counter) {
        this(timestamp, machineIdentifier, processIdentifier, counter, true);
    }

    private ContextId(final int timestamp, final int machineIdentifier, final short processIdentifier, final int counter,
     ...
     * @throws IllegalArgumentException if the string is not a valid hex string representation of an ContextId
     */
    public ContextId(final String hexString) {
     ...
     */
    public ContextId(final byte[] bytes) {
        if (bytes == null) {
            throw new IllegalArgumentException();
        }
        if (bytes.length != 12) {
    ...
    /**
     * Creates an ContextId
     *
     * @param timestamp                   time in seconds
     * @param machineAndProcessIdentifier machine and process identifier
     * @param counter                     incremental value
     */
    ContextId(final int timestamp, final int machineAndProcessIdentifier, final int counter) {
     ...
     *
     * @return a string representation of the ContextId in hexadecimal format
     */
    ...
    public boolean equals(final Object o) {
        ...
        ContextId objectId = (ContextId) o;
    ...
    @Override
    public int compareTo(final ContextId other) {
        if (other == null) {
    ...
    private static byte[] parseHexString(final String s) {
        if (!isValid(s)) {
            throw new IllegalArgumentException("invalid hexadecimal representation of an ContextId: [" + s + "]");
        }
