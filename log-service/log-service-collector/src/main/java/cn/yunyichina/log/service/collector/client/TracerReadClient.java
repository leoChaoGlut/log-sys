...
import cn.yunyichina.log.service.collector.client.fallback.factory.TracerReadFallbackFactory;
 ...
 */
@FeignClient(
        name = "${tracer-read-id:tracer-read}",
        fallbackFactory = TracerReadFallbackFactory.class
)
@RequestMapping("trace/linked")
public interface TracerReadClient {
