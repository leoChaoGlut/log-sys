...
public class ScheduleService {
     ...
     */
    @Async
    public void recordLastestContextCount(Map<Long, ContextIndexBuilder.ContextInfo> contextInfoMap, String logCollectorName) {
        Set<Long> countSet = contextInfoMap.keySet();
        Long lastestCount = Collections.max(countSet);
        propMapUtil.put(logCollectorName, Key.CONTEXT_COUNT, lastestCount + "");
    }
}
