 ...
 */
//@Component
public class ApplicationReadyListenerBak implements ApplicationListener<ApplicationReadyEvent> {

    final LoggerWrapper logger = LoggerWrapper.getLogger(ApplicationReadyListenerBak.class);
